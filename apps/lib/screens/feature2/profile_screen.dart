...
class _ProfileScreenState extends State<ProfileScreen> {
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            _buildSectionHeader('Personal Information and goals', isDarkMode),
                            _buildOptionItem(
                            ...
                            _buildOptionItem(
                              ...
                              subtitle: 'Degree, branch, CGPA (Degree & Branch fixed)',
                              isDarkMode: isDarkMode,
                              onTap: () => _showAcademicDetailsDialog(isDarkMode),
                            ),
                            ...
                            _buildOptionItem(
                              ...
                              title: 'Achievements',
                              subtitle: '${_achievements.length} achievements earned',
                              isDarkMode: isDarkMode,
                            ...
                            _buildOptionItem(
                              ...
                              isDarkMode: isDarkMode,
                              onTap: () => _showComingSoonDialog('Help & Support', isDarkMode),
                            ),
                            _buildOptionItem(
                            ...
                            Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 10, 
                                  color: isDarkMode ? AppTheme.darkTextLight : AppTheme.textLightColor
                                ),
                              ),
                            ),
                          ],
  ...
  void _showFullEditDialog() {
    ...
    final preferredCompaniesController = TextEditingController(text: _preferredCompanies);
    final expectedPackageController = TextEditingController(text: _expectedPackage);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // Year Dropdown - FIXED with container width and expanded
                  Container(
                    width: double.infinity,
                    margin: const EdgeInsets.only(bottom: 12),
                    decoration: BoxDecoration(
                      border: Border.all(
                        color: isDarkMode ? AppTheme.darkDivider : AppTheme.dividerColor
                      ),
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    ...
                    backgroundColor: isDarkMode ? AppTheme.primaryColor : Colors.green,
                  ),
                );
              },
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildInfoRow('Verification', _isVerified ? 'Verified ✓' : 'Not Verified', isDarkMode),
          ],
        ),
        actions: [
          TextButton(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildInfoRow('Preferred Companies', _preferredCompanies, isDarkMode),
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Add Achievement', style: TextStyle(fontSize: 12)),
                style: ElevatedButton.styleFrom(
  ...
  void _showEditAchievementDialog(int index, bool isDarkMode) {
    final titleController = TextEditingController(text: _achievements[index]['title']);
    final dateController = TextEditingController(text: _achievements[index]['date']);
